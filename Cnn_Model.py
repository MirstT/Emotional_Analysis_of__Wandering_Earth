...
class TextCNN(object):
    ...
    def cnn(self):
        ...
        with tf.name_scope("cnn"):
            # 卷积层
            conv = tf.layers.conv1d(embedding_inputs, self.config.num_filters, self.config.kernel_size, name='conv') #文本纵向一维卷积
            # 最大池化层
        ...
        with tf.name_scope("optimize"):
            ...
            self.loss = tf.reduce_mean(cross_entropy) #求均值
            # 优化器
